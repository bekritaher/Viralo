...
<div class="inner-block">
    <div class="product-block">
    	<div class="pro-head">
    	 ...
    	 <form method="POST" action="ajoutProduit.php" class="com-mail">
<table class="table">
<tr>
<td>ID Produit</td>
<td><input type="number" name="id_produit" id="ID" min="1" required></td>
</tr>
<tr>
<td>Nom Produit</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="nom_produit" name="nom_produit" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
   oninput="setCustomValidity('')" >
</td>
</tr>
<tr>
<td>Reference</td>
<td><input type="number" name="reference" id="reference" min="1" required></td>

</tr>
<tr>
<td>quantite</td>
<td><input type="number" name="quantite" min="1" required></td>
</tr>
...
<select name="idca" id="idca" required>
    ...
    <?php
        include "../../config.php";
    $res="select nom from categorie ";
    $db = config::getConnexion();
        $liste=$db->query($res);

        foreach($liste as $row){
          $option="<option>" . $row['nom'];
...
<tr>
<td>prix</td>
<td><input type="number" name="prix" min="1" required></td>
</tr>
<tr>
<td>image Produit</td>
...
<tr>
<td>Promotion</td>
<td><input type="text" name="promotion" required></td>
</tr>
<tr>
<td></td>
...
<div class="copyrights">	 <p>© crée en 2020 </p>
