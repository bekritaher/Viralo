...
<tr>
<td>Code question</td>
<td><input type="number" name="code_question" id="code_question" min="1" value="<?PHP echo $id ?>"></td>
</tr>
<tr>
<td>Question</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="question" name="question" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
...
<tr>
<td>Reponse</td>
<td><input type="number" name="reponse" id="reponse" min="1" value="<?PHP echo $id ?>"></td>
</tr>
