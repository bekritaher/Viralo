...
$listeProduits=$produit1C->AffichProduit();
...
foreach($listeProduits as $row){
  ...
  <td><?PHP echo $row['idca']; ?></td>
  <td><?PHP echo $row['prix']; ?></td>
  <td><?PHP echo $row['description']; ?></td>
  <td><?PHP echo $row['promotion']; ?></td>

  <td><form method="POST" action="supprimerProduit.php">
  <input class="btn btn-1 btn-danger" type="submit" name="supprimer" OnClick="return confirm('Voulez vous vraiment supprimer ce produit ?');" value="supprimer">
...
function myFunction() {
  ...
  <td><a class="btn btn-1 btn-warning" href="ModifierProduit.php?id_produit=<?PHP echo $row['id_produit']; ?>">
  Modifier</a>
