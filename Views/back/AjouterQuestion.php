...
<tr>
<td>Code question</td>
<td><input type="number" name="code_question" id="code_question" min="1" required></td>
</tr>
<tr>
<td>Question</td>
...
<td>Reponse</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="reponse" name="reponse" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
   oninput="setCustomValidity('')">
</td>
</tr>
