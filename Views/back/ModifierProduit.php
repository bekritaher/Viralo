									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="images/taher.png" alt=""> </span> 
												<div class="user-name">
													<p>Taher</p>
...
<tr>
<td>ID Produit</td>
<td><input type="number" name="id_produit" id="ID" min="1" value="<?PHP echo $id_produit ?>"></td>
</tr>
<tr>
<td>Nom Produit</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="nom_produit" name="nom_produit" value="<?PHP echo $nom_produit ?>" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
...
<tr>
<td>Reference</td>
<td><input type="number" name="reference" id="ID" min="1" value="<?PHP echo $reference ?>"></td>
</tr>
<tr>
<td>Quantite</td>
<td><input type="number" name="quantite" id="ID" min="1" value="<?PHP echo $quantite ?>"></td>
</tr>
<tr>
<td>ID categorie</td>
<td>

<select name="idca" id="idca" required>
  
    <?php
        //include "../../config.php";
    $res="select id from categorie ";
...
<tr>
<td>Prix Produit</td>
<td><input type="number" name="prix" id="ID" min="1" value="<?PHP echo $prix ?>"></td>
</tr>
<tr>
<td>image Produit</td>
<td><input type="file" name="img" value="<?PHP echo $img ?>" required></td>
</tr>
<tr>
<td>Description</td>
<td><input type="text" name="description" id="ID"  value="<?PHP echo $description ?>"></td>
</tr>
<tr>
<td>Promotion</td>
<td><input type="text" name="promotion" id="ID"  value="<?PHP echo $promotion?>"></td>
</tr>
<tr>
<td></td>
...
<tr>
<td></td>
<td><input type="hidden" name="id_ini" value="<?PHP echo $_GET['id_produit'];?>"></td>
</tr>
</table>
</form>
		    ...
		    <div class="menu">
		      <ul id="menu" >
		         ...
		         <li><a href="#"><i class="fa fa-cogs"></i><span>Gestion de Q&R</span><span class="fa fa-angle-right" style="float: right"></span></a>
		         	 <ul id="menu-academico-sub" >
			            <li id="menu-academico-boletim" ><a href="ConsulterQuestion.php">Consulter Question</a></li>
			            <li id="menu-academico-avaliacoes" ><a href="SupprimerQuestion.php">Supprimer Question</a></li>
		             </ul>
		         </li>
...
<script type="text/javascript">
  ...
  function notify() {
    var notification = new Notification('PRODUIT', {
      icon: '../../notifier.png',
      body: "Hey! Produit modifié avec succés!",

    });

    notification.onclick = function () {
      window.location.replace("afficherProduit.php");      
    };
...
if (isset($_POST['modifier'])){
  $produit=new Produit($_POST['id_produit'],$_POST['nom_produit'],$_POST['reference'],$_POST['quantite'],$_POST['idca'],$_POST['prix'],$_POST['img'],$_POST['description'],$_POST['promotion']);
