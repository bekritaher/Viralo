...
$listeQuestions=$question1C->AfficherQuestions();
...
<?PHP
foreach($listeQuestions as $row){
  ?>
  <tr>
  <td><?PHP echo $row['code_question']; ?></td>
  <td><?PHP echo $row['question']; ?></td>
  <td><?PHP echo $row['reponse']; ?></td>
  <td><form method="POST" action="SupprimerQuestion.php">
  ...
  <input type="hidden" value="<?PHP echo $row['code_question']; ?>" name="code_question">
  </form>
  </td>
