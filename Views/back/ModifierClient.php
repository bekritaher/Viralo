...
<tr>
<td>ID</td>
<td><input type="number" name="id" id="id" min="1" value="<?PHP echo $id ?>"></td>
</tr>
<tr>
<td>nom</td>
...
<td>prenom</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="prenom" name="prenom" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
   oninput="setCustomValidity('')" value="<?PHP echo $nom ?>">
</td>
</tr>
<tr>
<td>adresse</td>
<td><div id="div" style="color: red;"></div>
	<input type="text" id="adresse" name="adresse" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres seulement')" 
   oninput="setCustomValidity('')" value="<?PHP echo $nom ?>">
</td>
</tr>
<tr>
...
<script type="text/javascript">
  ...
  function notify() {
    var notification = new Notification('CATEGORIE', {
      icon: '../../notifier.png',
      body: "Hey! Categorie modifiée avec succés!",

    });

    notification.onclick = function () {
      window.location.replace("AfficherCategorie.php");      
    };
...
if (isset($_POST['modifier'])){
  $question=new Question($_POST['code_question'],$_POST['question'],$_POST['reponse']);
  $questionC->ModifierQuestion($question,$_POST['code_question']);
  echo $_POST['code_question'];
