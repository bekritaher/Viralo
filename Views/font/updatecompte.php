              ...
              <nav class="site-navigation text-right" role="navigation">
                <div class="container">
                  ...
                  <ul class="site-menu main-menu js-clone-nav d-none d-lg-block">
                    ...
                    <li>
                      <a href="#projects-section" class="nav-link">Catégories</a>
                    </li>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            ...
            <table>
              <tr>
                <td>
            <h3 class="mb-0"><a href="">Butterfly</a></td>
              <td>
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
           ...
           <table>
              <tr>
                <td>
            <h3 class="mb-0"><a href="#">Sandra</a></td>
              <td>
                <a href="AjoutCommande.php ?id= <?php echo 2 ?>">
             <div class="cadreAj"><div class="fas fa-cart-plus"></div></div></h3></td></a>  </tr>
            </table>
          </div>
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            ...
            <table>
              <tr>
                <td>
            <h3 class="mb-0"><a href="#">Ashe</a></td>
              <td>
                                <a href="AjoutCommande.php ?id= <?php echo 3 ?>">
             <div class="cadreAj"><div class="fas fa-cart-plus"></div></div></h3></td></a>  </tr>
            </table>
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="images/img_4.jpg" class="d-block figure" data-fancybox="gallery">
              ...
              <tr>
                <td>
            <h3 class="mb-0"><a href="#">Star</a></td>
              <td>
                                <a href="AjoutCommande.php ?id= <?php echo 4 ?>">
             <div class="cadreAj"><div class="fas fa-cart-plus"></div></div></h3></td></a>  </tr>
            </table>
          ...
          <div class="col-lg-4 col-md-6 mb-4 project-entry">
            <a href="images/img_5.jpg" class="d-block figure" data-fancybox="gallery">
              ...
              <tr>
                <td>
            <h3 class="mb-0"><a href="#">Shen</a></td>
              <td>
                                <a href="AjoutCommande.php ?id= <?php echo 5 ?>">
             <div class="cadreAj"><div class="fas fa-cart-plus"></div></div></h3></td></a>  </tr>
            </table>
         ...
         <table>
              <tr>
                <td>
            <h3 class="mb-0"><a href="AjoutCommande.php ?id= <?php echo 6 ?>">Nocturne</a></td>
              <td>
                                <a href="AjoutCommande.php ?id= <?php echo 6 ?>">
             <div class="cadreAj"><div class="fas fa-cart-plus"></div></div></h3></td></a>  </tr>
            </table>
          </div>
        </div>
